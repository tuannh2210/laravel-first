...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic theme/admin Theme #1 | 404 Page Option 3</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Preview page of Metronic theme/admin Theme #1 for 404 page option 3" name="description" />
        ...
        <link href="{{asset('theme/admin/pages/css/error.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body class=" page-404-3">
        <div class="page-inner">
            <img src="{{asset('theme/admin/pages/media/pages/earth.jpg')}}" class="img-responsive" alt=""> </div>
        <div class="container error-404">
            <h1>404</h1>
            <h2>Houston, we have a problem.</h2>
            <p> Actually, the page you are looking for does not exist. </p>
            <p>
                <a href="{{route('homepage')}} " class="btn red btn-outline"> Return home </a>
                <br> </p>
        </div>
        <!-- BEGIN CORE PLUGINS -->
