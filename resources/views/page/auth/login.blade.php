        ...
        <div class="content">
            ...
            <form  id="login-form" class="login-form" action="{{ route('login') }}" method="post">
                ...
                <div class="alert alert-danger display-hide" >
                    <button class="close" data-close="alert"></button>
                    <span> Nhập tên và mật khẩu </span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="text" placeholder="Username or email" name="name"> 
                </div>
                <div class="form-group">
                    {{-- Validate = php lỗi --}}
                    @if (count($errors) > 0)
            ...
            <form class="forget-form"  method="post" action="{{route('forget-pw')}}">
                {{csrf_field()}}
            ...
            <form class="forget-form"  method="post" action="{{route('save.reset-pw')}}">
                {{csrf_field()}}
                <h3>Forget Password </h3>
                <div class="form-group">
                    <div class="input-icon">
